...
from core.nn import InvertedResidual, _ConvBNReLU, _DepthwiseConv
...
class MobileNet(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        features = [
            _ConvBNReLU(3, input_channels, 3, 2, 1, norm_layer=norm_layer)
        ]
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.classifier = nn.Sequential(
            nn.Dropout2d(0.2), nn.Linear(last_channels, num_classes)
        )
...
# Constructor
def get_mobilenet(
    multiplier=1.0, pretrained=False, root="~/.torch/models", **kwargs
):
