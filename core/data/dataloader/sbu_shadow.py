...
class SBUSegmentation(SegmentationDataset):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SBUSegmentation, self).__init__(
...
def _get_sbu_pairs(folder, split="train"):
            ...
            for filename in files:
                if filename.endswith(".jpg"):
                    ...
                    if os.path.isfile(imgpath) and os.path.isfile(maskpath):
                        ...
                        print(
                            "cannot find the mask or image:", imgpath, maskpath
                        )
        print(
            "Found {} images in the folder {}".format(
    ...
    if split == "train":
        img_folder = os.path.join(
            folder, "SBUTrain4KRecoveredSmall/ShadowImages"
        )
        mask_folder = os.path.join(
            folder, "SBUTrain4KRecoveredSmall/ShadowMasks"
        )
