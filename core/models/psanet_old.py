...
__all__ = [
    ...
    "get_psanet_resnet101_voc",
    "get_psanet_resnet152_voc",
    "get_psanet_resnet50_citys",
    "get_psanet_resnet101_citys",
...
class _PSAHead(nn.Module):
    def __init__(self, nclass, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        self.distribute = _DistributeModule(
            2048, 512, 60, 60, norm_layer, **kwargs
        )
    ...
    def forward(self, x):
        ...
        global_feature = torch.cat(
            [global_feature_collect, global_feature_distribute], dim=1
        )
    ...
    def forward(self, x):
        ...
        for i in range(x_shrink.shape[0]):
            ...
            global_feature_collect_list.append(
                torch.mm(x_shrink_i, ca_i).view(
                    1, self.reduced_channels, self.feat_h // 2, self.feat_w // 2
                )
            )
