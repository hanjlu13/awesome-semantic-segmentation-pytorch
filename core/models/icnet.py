...
__all__ = [
    ...
    "get_icnet_resnet101_citys",
    "get_icnet_resnet152_citys",
]
...
class _ICHead(nn.Module):
    def __init__(self, nclass, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        self.cff_12 = CascadeFeatureFusion(
            512, 64, 128, nclass, norm_layer, **kwargs
        )
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.conv_low = nn.Sequential(
            nn.Conv2d(
                low_channels, out_channels, 3, padding=2, dilation=2, bias=False
            ),
    ...
    **kwargs
    ...
    if pretrained:
        ...
        model.load_state_dict(
            torch.load(
                get_model_file(
                    "icnet_%s_%s" % (backbone, acronyms[dataset]), root=root
                ),
                map_location=device,
            )
        )
