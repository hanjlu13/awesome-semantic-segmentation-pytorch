...
__all__ = [
    "CCNet",
    "get_ccnet",
    "get_ccnet_resnet50_citys",
    "get_ccnet_resnet101_citys",
    "get_ccnet_resnet152_citys",
    "get_ccnet_resnet50_ade",
    "get_ccnet_resnet101_ade",
    ...
    **kwargs
    ...
    if pretrained:
        ...
        model.load_state_dict(
            torch.load(
                get_model_file(
                    "ccnet_%s_%s" % (backbone, acronyms[dataset]), root=root
                ),
                map_location=device,
            )
        )
