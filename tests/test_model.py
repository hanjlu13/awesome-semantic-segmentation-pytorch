...
from core.utils.loss import EncNetLoss, ICNetLoss, MixSoftmaxCrossEntropyLoss
from core.utils.lr_scheduler import LRScheduler
from core.utils.score import compute_score, hist_info
from core.utils.visualize import get_color_pallete


def parse_args():
    parser = argparse.ArgumentParser(
        description="Semantic Segmentation Overfitting Test"
    )
    # model
    parser.add_argument(
        "--model",
        ...
        default="ocnet",
        choices=[
            "fcn32s/fcn16s/fcn8s/fcn/psp/deeplabv3/danet/denseaspp/bisenet/encnet/dunet/icnet/enet/ocnet"
        ],
    ...
    parser.add_argument(
        ...
        default="resnet50",
        choices=[
            "vgg16/resnet18/resnet50/resnet101/resnet152/densenet121/161/169/201"
        ],
...
class VOCSegmentation(object):
    ...
    def get(self):
        img, mask = (
            self._img_transform(self.img),
            self._mask_transform(self.mask),
        )
        return img, mask
